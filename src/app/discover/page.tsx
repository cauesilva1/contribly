...
export default async function DiscoverPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8">
        <h1 className="font-display text-4xl text-[#0d1117]">Descobrir projetos</h1>
        <p className="mt-2 text-[#57606a]">
          Filtre por linguagem ou busque por título, descrição e tags.
        </p>
      </div>

      <form className="mb-8 grid gap-3 rounded-xl border border-[#d0d7de] bg-white p-4 md:grid-cols-[1fr_200px_auto]">
        <div>
        ...
        <div className="flex items-end">
          <button
            type="submit"
            className="h-10 w-full rounded-md bg-[#24292f] px-4 text-sm text-white"
          >
            Filtrar
          </button>
        </div>
